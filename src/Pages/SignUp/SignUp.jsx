                    ...
                    <div className="card flex-shrink-0 w-full max-w-sm shadow-2xl bg-base-100">
                        <form onSubmit={handleSubmit(onSubmit)} className="card-body">
                            ...
                            <div className="form-control">
                                ...
                                {errors.password?.type === 'maxLength' && <p className="text-red-600">Password less then 21 characters</p>}
                        ...
                        <p><small>Already have an acccount <Link to='/login'>Login</Link> </small></p>
                    </div>
                </div>
            </div>
        </>
